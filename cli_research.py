...
async def run_research(question: str, model: str = "deepseek:deepseek-reasoner", search_api: str = "tavily"):
    """运行深度研究并返回结果"""
...
def main():
    ...
    result = asyncio.run(run_research(args.question, args.model, args.search, allow_clarification))
